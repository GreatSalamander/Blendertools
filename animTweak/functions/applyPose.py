                ...
                if dstChannelStr:
                    ...
                    if (not select) or group in select:
                        ...
                        if type(dstChannel) == type(1):
                            exec('%s = int(fcurve.evaluate(pose_index))'%dstChannelStr)
                        else:
                            exec('%s = fcurve.evaluate(pose_index)'%dstChannelStr)
                        #  KEYFRAME CREATION
